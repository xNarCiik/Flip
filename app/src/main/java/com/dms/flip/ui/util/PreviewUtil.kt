...
val previewCommunityUiStateFull = CommunityUiState(
    ...
    friends = previewFriends.toPersistentList(),
    suggestions = previewSuggestions.toPersistentList(),
    pendingRequests = previewPendingRequests.toPersistentList(),
    sentRequests = previewSentRequests.toPersistentList(),
    searchQuery = "",
